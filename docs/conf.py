...
myst_url_schemes = {
    "gh-issue": {
        "url": "https://github.com/bytewax/bytewax-clickhouse/issues/"
        "{{ path }}#{{ fragment }}",
        "title": "Issue #{{path}}",
        "classes": ["github"],
    },
    "gh-path": {
        "url": f"https://github.com/bytewax/bytewax-clickhouse/blob/{git_id}"
        "#{path}}#",
        "title": "bytewax/bytewax-clickhouse{{ path }}",
        "classes": ["github"],
    },
    "http": None,
    "https": None,
